...
public class Tiger extends WildAnimal{
    ...
    public Tiger(String breed, char gender, int age, String size, String color, boolean isWild, boolean isFriendly, boolean isPlayable) {
        super("Tiger", breed, gender, age, size, color, isWild, isFriendly, isPlayable);
    }
